  ...
  <div>
    <q-layout view="lHh Lpr lff" container style="height: 100vh">
      <q-header elevated class="bg-cyan-8">
        <q-toolbar>
          <q-toolbar-title>Order Service</q-toolbar-title>
      ...
      <q-drawer v-model="drawer" show-if-above :width="200" :breakpoint="400">
        ...
        >
          <q-list padding>
            <RouterLink to="/customers" class="text-black noUnderline"
              ><q-item
            ...
            <RouterLink to="/orders" class="text-black noUnderline">
              <q-item
...
export default {
  ...
  async created() {
    ...
    this.selectedItem = this.router.path?.includes("customers")
      ? "customers"
      : "orders";
  },
